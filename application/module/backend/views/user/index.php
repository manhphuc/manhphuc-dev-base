                                            ...
                                            <table id="yivicTableAjax-ordering" class="table table-bordered table-striped" >
                                                ...
                                                if ( !empty( $this->Items ) ) {
                                                    foreach ( $this->Items as $key => $value ) {
                                                        ...
                                                        $arrInfo        = [
                                                            ['name' => 'Username',  'value' => Helper::highlight($value['username'], BEViewConfigs::search_field(), BEViewConfigs::search_value(), 'username')],
                                                            ['name' => 'Fullname',  'value' => Helper::highlight($value['fullname'], BEViewConfigs::search_field(), BEViewConfigs::search_value(), 'fullname')],
                                                            ['name' => 'Email',     'value' => Helper::highlight($value['email'], BEViewConfigs::search_field(), BEViewConfigs::search_value(), 'email')]
                                                        ];
                                                        $info           = HTML::showUserInfo( $arrInfo );
                                                        $status         = Helper::cmsStatus( $value['status'], URL::createLink( 'backend', 'user', 'ajaxStatus', [ 'id' => $id, 'status' =>  $value['status'] ] ), $id );
                                                        $group          = Form::select( 'select-group', $this->slbGroup, $value['group_id'], ['class' => 'custom-select custom-select-sm', 'style' => 'width: unset', 'id' => $value['id'], 'data-id' => $value['id']] );
                                                        ...
                                                        $str_output .= '        <a class="" href="">'.$info.'</a>';
                                                        $str_output .= '    </td> <!-- End Title -->';

                                                        $str_output .= '    <!-- ACP Group -->';
                                                        $str_output .= '    <td class="position-relative">'.$group.'</td> <!-- End ACP Group -->';
